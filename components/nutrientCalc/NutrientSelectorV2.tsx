...
export default function NutrientSelectorV2() {
  const { t } = useTranslation();
  const { data, actions } = useNutrientsV2();
...
function LabeledNutrientV2({
  ...
  return (
    <label className="flex items-center gap-2">
      ...
      <SettingsDialogV2 nutrientKey={nutrientKey} index={index} />
    </label>
  );
}
