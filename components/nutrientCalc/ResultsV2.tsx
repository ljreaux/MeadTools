...
import { useNutrientsV2 } from "@/components/providers/NutrientProviderV2"; // <-- adjust path to where your V2 provider exports this
...
function ResultsV2() {
  ...
  const { data, derived } = useNutrientsV2();
