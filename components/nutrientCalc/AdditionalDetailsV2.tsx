...
import { useNutrientsV2 } from "@/components/providers/NutrientProviderV2"; // adjust import path
...
export default function AdditionalDetailsV2() {
  const { t, i18n } = useTranslation();
  const locale = i18n.language;

  const { data, derived, actions } = useNutrientsV2();
